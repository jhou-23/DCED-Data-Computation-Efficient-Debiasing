...
class StereoSetRunner:
    ...
    def __init__(
        ...
        Args:
            ...
            score_type (`str`): The StereoSet scoring mechanism to use. Must be either "likelihood"
                or "effect-size".
    ...
    def evaluate_intrasentence(self):
        if self._score_type == "likelihood":
            ...
            sentence_probabilities = self._effect_size_score()
        ...
        for cluster in tqdm(clusters):
            ...
            for sentence in cluster.sentences:
                ...
                if self._is_self_debias:
                    ...
                    logits = logits[
                        :, bias_type_to_position[self._bias_type] :, :
                    ]
